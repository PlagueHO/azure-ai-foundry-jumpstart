"""
Unit tests for the tech_support module.
"""
...
# Also add the parent module path for the base class
parent_module_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 
                                                 os.path.pardir, os.path.pardir,
                                                 "src", "data_generator"))
...
@patch("tech_support.random.choice")
...
@patch("uuid.uuid4")
@patch("tech_support.datetime")
@patch("tech_support.TechSupportTool._random_attributes")
