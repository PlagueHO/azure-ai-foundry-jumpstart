...
This test suite uses mocking to test the RetailProductTool class without
requiring the full data_generator package dependencies.
"""
...
# Mock the DataGeneratorTool class
...
# Setup mocks
sys.modules['data_generator.tool'] = Mock()
sys.modules['data_generator.tool'].DataGeneratorTool = MockDataGeneratorTool
        
# Add src to path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../src")))
        
# Now we can import the RetailProductTool with all dependencies mocked
from src.data_generator.tools.retail_product import RetailProductTool
