...
The Azure AI Foundry Jumpstart Solution Accelerator deploys an [Azure AI Foundry environment](https://learn.microsoft.com/azure/ai-foundry/how-to/create-secure-ai-hub) and supporting services into your Azure subscription. This accelerator is designed to be used as a secure environment for exploring and experimenting with Azure AI Foundry capabilities using the [Foundry Project type](https://learn.microsoft.com/azure/ai-foundry/what-is-azure-ai-foundry#project-types).
...
It automates the deployment of the Azure AI Foundry into a private network using the [how to configure a private link for Azure AI Foundry](https://learn.microsoft.com/azure/ai-foundry/how-to/configure-private-link?tabs=azure-portal&pivots=fdp-project) page.
...
- **Foundry Project Mode**: Deploys the AI Foundry environment using the recommended [Foundry Project type](https://learn.microsoft.com/azure/ai-foundry/what-is-azure-ai-foundry#project-types), rather than the older Foundry Hub type.
...
> [!NOTE]
> This will deploy the Azure AI Foundry Hub and Foundry Projects with public endpoints. You can access the Azure AI Foundry Hub and Foundry Projects from the public internet. This is recommended for demonstration and testing purposes or when there is no requirement for network isolation.
...
azd env set AZURE_AI_FOUNDRY_PROJECT_DISPLAY_NAME "My AI Project"
...
> [!IMPORTANT]
> If you deployed the solution accelerator with network isolation, you will need to use a VPN or Azure Bastion to access the Azure AI Foundry Hub and Foundry projects. The Azure AI Foundry Hub and Foundry projects are not accessible from the public internet.
